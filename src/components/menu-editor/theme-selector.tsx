      ...
      <SideSection title="Tipografía">
        <Popover>
          <PopoverTrigger asChild>
            <button className="flex w-full flex-row items-center justify-between rounded-lg border-[0.5px] border-gray-300 px-4 py-2 text-left shadow-xs transition-colors hover:border-lime-400 hover:ring-2 hover:ring-lime-100 dark:border-gray-700 dark:hover:border-green-600 dark:hover:ring-green-900">
              <div>
